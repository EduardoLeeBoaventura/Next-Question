  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="border: 1px solid #0005;border-width: 1px 0px 1px 0px;">
        <form id="form-modal-add" action="/api/post/questionarios/cadastro.php" method="post">
          ...
          <div class="form-group">
            ...
            <select name="questionarios" id="questionarios-add" class="select-select form-control" onchange="searchAcoesPrivilegio(this.value)">
              ...
              <?php
              $questionarios = $questionarios_handler->listar();

              foreach ($questionarios as $info_questionarios) {
              ?>
                <option value="<?= $info_questionarios['ref'] ?>"> <?= $info_questionarios['nome'] ?></option>
              <?php
              }
              ?>
            </select>
