...
?>
<div class="modal fade" id="modal-add" tabindex="-1" aria-labelledby="modal-add-niveis_acessosLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="modal-add-niveis_acessosLabel">Cadastrar Usuario(a)</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="border: 1px solid #0005;border-width: 1px 0px 1px 0px;">
        <form id="form-modal-add" action="/api/post/niveis_acessos/cadastro.php" method="post">
