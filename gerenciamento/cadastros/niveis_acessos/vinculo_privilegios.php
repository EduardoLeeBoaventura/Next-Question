...
?>
<div class="modal fade" id="modal-vinculo-privilegios" tabindex="-1" aria-labelledby="modal-vinculo-privilegios-niveis_acessosLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="modal-vinculo-privilegios-niveis_acessosLabel">Cadastrar Usuario(a)</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="border: 1px solid #0005;border-width: 1px 0px 1px 0px;">
        <div class="border border-black rounded" style="height: 300px;overflow: auto;" id="vinculos-niveis-privilegios">
          <table class="table table-bordered border border-black" id="table-vinculos-niveis-privilegios">
          </table>
        </div>

        <form id="form-modal-vinculo-privilegios" action="/api/post/niveis_acessos/vinculo_privilegios.php" method="post">
          <input type="hidden" name="nivel" id="ref_nivel-vinculo-privilegios">
