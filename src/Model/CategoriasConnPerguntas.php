<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "src" . DIRECTORY_SEPARATOR . "resources" . DIRECTORY_SEPARATOR . "system_functions.php";
    ...
    class CategoriasConnPerguntas extends SQL_CRUD{
        private $table = "categorias_conn_perguntas";
        ...
        public function select(String|Array|Null $columns = "CCP.*", Array|Null $conditions = null, Array|String|Null $group_by = null, Array|String|Null $order_by = null, String|Null $order_direction = "<", String|Int|Null $limit_min = 100, String|Int|Null $limit_max = null) : Object{

            $tables = [
                "perguntas P" => [],
                "categorias_conn_perguntas CCP" => ["CCP.id_pergunta = P.id"],
                "categorias C" => [["C.id", "CCP.id_categoria"]],
            ];
